...
<body>
    ...
    <form action="./user_form_write.php" method="post">
...
<?php
    if (isset($_POST['nameUser']) && isset($_POST['email']) && isset($_POST['password'])){
        $client = new Client($_SESSION['usuari']->lastID(),$_POST['nameUser'],$_POST['email'],password_hash($_POST['password'], PASSWORD_DEFAULT));
        if ($_SESSION['usuari']->checkID($client)){
            $_SESSION['usuari']->createClient($client);
        }
    }
?>